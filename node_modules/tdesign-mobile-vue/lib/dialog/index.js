...
function create(props) {
  ...
  instance = vue.defineComponent({
    render: function render() {
      return vue.h(dialog_dialog["default"], _objectSpread(_objectSpread({}, propsObject), {}, {
  ...
  vue.createApp(instance).mount(root);
...
exports.DialogPropsDefault = DialogPropsDefault;
