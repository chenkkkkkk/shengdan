...
var script = vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var itemStyle = vue.computed(function () {
      ...
      var column = 4;
      if (isObject__default["default"](gridConfig.value)) {
    ...
    var formatFileToUploadFile = function formatFileToUploadFile(files) {
      ...
      if (!format || !isFunction__default["default"](format)) {
        var res = [];
    ...
    var handleBeforeUpload = function handleBeforeUpload(file) {
      if (props.beforeUpload && isFunction__default["default"](props.beforeUpload)) {
    ...
    var handleSuccess = function handleSuccess(_ref3) {
      ...
      file.status = "success";
      var res = response;
      if (props.formatResponse && isFunction__default["default"](props.formatResponse)) {
    ...
    var handleError = function handleError(options) {
      ...
      file.status = "fail";
      var res = response;
      if (!resFormatted && props.formatResponse && isFunction__default["default"](props.formatResponse)) {
        res = props.formatResponse(response, {
          file: file
        });
      }
