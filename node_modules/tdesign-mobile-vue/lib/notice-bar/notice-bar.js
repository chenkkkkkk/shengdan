...
var iconDefault = {
  ...
  error: vue.h(tdesignIconsVueNext.CloseCircleFilledIcon)
};
var script = vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var prefixIconContent = vue.computed(function () {
      ...
      if (isFunction__default["default"](props.prefixIcon) || context.slots.prefixIcon) {
        iconContent = shared_render.renderTNode(internalInstance, "prefixIcon");
    ...
    var _useVModel = shared_useVModel_index.useVModel(visible, modelValue, props.defaultVisible, props.onChange),
